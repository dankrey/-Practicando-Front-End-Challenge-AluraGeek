...
// Función para crear una tarjeta de productos del api
...
const render = async () => {
    try {
        ...
        errorMessage.textContent = "No fue posible cargar la lista de productos:Error 404";
        errorDiv.appendChild(errorMessage);
        const errorImage = document.createElement("img");
        errorImage.classList.add("error-image");
        errorImage.src = "assets/images/sin-conexion.png";
